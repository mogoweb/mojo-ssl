...
#define ROTL32(x, n) bssl::CRYPTO_rotl_u32(x, n)
...
static const uint32_t SM4_SBOX_T1[256] = {
    ...
    0x6AF2986A, 0xD9AE77D9, 0xA8A8822A, 0xFA46BCFA, 0x10100414, 0x0FCFC00F,
    0xAA02A8AA, 0x11544511, 0x4C5F134C, 0x98BE2698, 0x256D4825, 0x1A9E841A,
    0x181E0618, 0x66FD9B66, 0x72EC9E72, 0x094A4309, 0x41511051, 0xD324F7D3,
    ...
    0x9E3BA59E, 0xF30CFFF3, 0xCF3FF0CF, 0xCDBF72CD, 0x5C4B175C, 0xEAB852EA,
    ...
    0x7BA6DD7B, 0xF709FEF7, 0x3AB68C3A, 0xBC932FBC, 0x0C0F030C, 0xFFFF03FC,
    ...
    0xF24CBEF2, 0xFD837EFD, 0x44445544, 0x67BDDA67, 0x712C5D71, 0x05454005,
    ...
    0x5F8BD45F, 0x2FE7C82F, 0xE4DD39E4, 0x21496821
};
...
static const uint32_t SM4_SBOX_T2[256] = {
    ...
    0x6A6AF298, 0xD9D9AE77, 0xA8A8822A, 0xFAFA46BC, 0x10100410, 0x0F0FCFC0,
    ...
    0x838360E3, 0xBABA16AC, 0x7575295C, 0xA6A69234, 0x6E6EF799, 0xD0D0E434,
    ...
    0xC7C735F2, 0x24242D09, 0x1717D1C6, 0x6F6FB9D6, 0x1B1BDEC5, 0x12129486,
...
static const uint32_t SM4_SBOX_T3[256] = {
    ...
    0x986A6AF2, 0x77D9D9AE, 0x2AA8A882, 0xBCFAFA46, 0x04101010, 0xC00F0FCF,
    ...
    0xF6D7D721, 0x8E3232BC, 0xB3C6C675, 0xE08F8F6F, 0x1D747469, 0xDBF5F52E,
    ...
    0xB499992D, 0x75D1D1A4, 0xD3434390, 0x1248485A, 0xBAE2E258, 0xE6979771,
    0xB6D2D264, 0xB2C2C270, 0x26ADAD8B, 0x68A5A5CD, 0x955E5ECB, 0x4B292962,
    0x0C30303C, 0x945A5ACE, 0x76DDDDAB, 0x7FF9F986, 0x649595F1, 0xBBE6E65D,
    0xC7F2F235, 0x0924242D, 0xC61717D1, 0x6FB9B9D6, 0xC51B1BDE, 0x86121294,
...
void SM4_encrypt(const uint8_t *in, uint8_t *out, const SM4_KEY *ks) {
  uint32_t B0 = load_u32_be(in);
  uint32_t B1 = load_u32_be(in + 4);
  uint32_t B2 = load_u32_be(in + 8);
  uint32_t B3 = load_u32_be(in + 12);

  // Use slow T function for all rounds for correctness verification
