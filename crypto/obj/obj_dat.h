...
static const ASN1_OBJECT kObjects[NUM_NID] = {
    ...
    {"id-alg-ml-kem-768", "ML-KEM-768", NID_ML_KEM_768, 9, &kObjectData[6232],
     0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {"SM2", "sm2", NID_sm2, 8, &kObjectData[6241], 0},
    {"ISO-CN", "ISO CN Member Body", NID_ISO_CN, 3, &kObjectData[6249], 0},
    {"oscca", "oscca", NID_oscca, 5, &kObjectData[6252], 0},
    {"sm-scheme", "sm-scheme", NID_sm_scheme, 6, &kObjectData[6257], 0},
    {"SM3", "sm3", NID_sm3, 8, &kObjectData[6263], 0},
    {"SM2-SM3", "SM2-with-SM3", NID_SM2_with_SM3, 8, &kObjectData[6271], 0},
    {"SM4-ECB", "sm4-ecb", NID_sm4_ecb, 8, &kObjectData[6279], 0},
    {"SM4-CBC", "sm4-cbc", NID_sm4_cbc, 8, &kObjectData[6287], 0},
    {"SM4-OFB", "sm4-ofb", NID_sm4_ofb128, 8, &kObjectData[6295], 0},
    {"SM4-CFB", "sm4-cfb", NID_sm4_cfb128, 8, &kObjectData[6303], 0},
    {"SM4-CTR", "sm4-ctr", NID_sm4_ctr, 8, &kObjectData[6311], 0},
    {"SM4-GCM", "sm4-gcm", NID_sm4_gcm, 8, &kObjectData[6319], 0},
    {"SM4-CCM", "sm4-ccm", NID_sm4_ccm, 8, &kObjectData[6327], 0},
    {"RSA-SM3", "sm3WithRSAEncryption", NID_sm3WithRSAEncryption, 8,
     &kObjectData[6335], 0},
    {"hmacWithSM3", "hmacWithSM3", NID_hmacWithSM3, 10, &kObjectData[6343], 0},
    {"ZUC", "zuc", NID_zuc, 8, &kObjectData[6353], 0},
    {"ZUC-128-EEA3", "zuc-128-eea3", NID_zuc_128_eea3, 8, &kObjectData[6361],
     0},
    {"ZUC-128-EIA3", "zuc-128-eia3", NID_zuc_128_eia3, 8, &kObjectData[6369],
     0},
...
static const uint16_t kNIDsInOIDOrder[] = {
    ...
    975 /* 1.2.156.10197.1 (OBJ_sm_scheme) */,
    ...
    978 /* 1.2.156.10197.1.104.1 (OBJ_sm4_ecb) */,
    979 /* 1.2.156.10197.1.104.2 (OBJ_sm4_cbc) */,
    980 /* 1.2.156.10197.1.104.3 (OBJ_sm4_ofb128) */,
    981 /* 1.2.156.10197.1.104.4 (OBJ_sm4_cfb128) */,
    982 /* 1.2.156.10197.1.104.7 (OBJ_sm4_ctr) */,
    983 /* 1.2.156.10197.1.104.8 (OBJ_sm4_gcm) */,
    984 /* 1.2.156.10197.1.104.9 (OBJ_sm4_ccm) */,
    987 /* 1.2.156.10197.1.201 (OBJ_zuc) */,
    972 /* 1.2.156.10197.1.301 (OBJ_sm2) */,
    976 /* 1.2.156.10197.1.401 (OBJ_sm3) */,
    977 /* 1.2.156.10197.1.501 (OBJ_SM2_with_SM3) */,
    985 /* 1.2.156.10197.1.504 (OBJ_sm3WithRSAEncryption) */,
    988 /* 1.2.156.10197.1.801 (OBJ_zuc_128_eea3) */,
    989 /* 1.2.156.10197.1.802 (OBJ_zuc_128_eia3) */,
    ...
    986 /* 1.2.156.10197.1.401.3.1 (OBJ_hmacWithSM3) */,
